...
public class MultiplicationDifficile : MonoBehaviour
{
    ...
    public void CreateNewQuestion()
    {
        ...
        int _number1 = rnd.Next(1, 100); // Lower the range for easier calculation
        int _number2 = rnd.Next(1, 100); // Lower the range for easier calculation
